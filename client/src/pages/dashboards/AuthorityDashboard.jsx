...
const AuthorityDashboard = () => {
  ...
  useEffect(() => {
    // Only fetch if admin or authority (this component is specifically AuthorityDashboard)
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                <Typography variant="h5" sx={{ color: "#ec4899" }} gutterBottom>
                  Opportunities Hub
                </Typography>
                <Typography variant="body2" color="text.secondary" paragraph>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent>
                <Typography variant="h5" sx={{ color: "#f59e0b" }} gutterBottom>
                  Lost & Found
                </Typography>
                <Typography variant="body2" color="text.secondary" paragraph>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6} md={3}>
                    ...
                    <Typography
                      ...
                      color="warning.main"
                    >
                      {analytics?.counts?.active_grievances || 0}
                    </Typography>
                  </Grid>
                  <Grid item xs={6} md={3}>
                    <Typography variant="subtitle2" color="text.secondary">
                    ...
                    <Typography
                      ...
                      color="success.main"
                    >
                      {analytics?.counts?.internships || 0}
                    </Typography>
                  </Grid>
                  <Grid item xs={6} md={3}>
                    <Typography variant="subtitle2" color="text.secondary">
